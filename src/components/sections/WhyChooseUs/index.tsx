            ...
            <div className="container mx-auto px-6 md:px-12">
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
                    ...
                    >
                        ...
                        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-64 h-64 bg-white/[0.03] blur-[100px] rounded-full" />
                        <div className="relative text-center p-12">
                            <motion.div
                                ...
                                className="text-8xl md:text-9xl font-black tracking-tighter text-white mb-6 drop-shadow-[0_0_30px_rgba(255,255,255,0.1)]"
                            >
                                500+
                            </motion.div>
