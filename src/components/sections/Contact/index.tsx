...
export const Contact = () => {
    ...
    const inputStyles =
        'w-full bg-white/5 border border-white/10 rounded-2xl px-5 py-3.5 focus:outline-none focus:border-white/20 transition-all placeholder:text-white/20 text-sm text-white hover:bg-white/7';
    const labelStyles =
            ...
            <div className="container mx-auto px-6 md:px-12">
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 xl:gap-20">
                    <div className="lg:col-span-4 flex flex-col justify-between">
                        <div>
                            ...
                            <p className="text-white/60 mt-6 max-w-md leading-relaxed">
                                Whether you're looking for a new lease, a
                                certified pre-owned vehicle, or want to check
                                your car's history, we're here to help.
                            </p>
                    ...
                    <motion.div
                        ...
                        viewport={{ once: true }}
                        className="lg:col-span-8 p-6 md:p-10 xl:p-14 rounded-4xl bg-white/3 border border-white/10 backdrop-blur-xl"
                    >
                        {/* Form Switcher */}
                        <div className="grid grid-cols-2 md:grid-cols-4 gap-2 mb-10 p-1.5 bg-white/5 rounded-4xl border border-white/5">
                            {forms.map((form) => (
                                <button
                                    key={form.id}
                                    onClick={() =>
                        ...
                        <AnimatePresence mode="wait">
                            {isSubmitted ? (
                                <motion.div
                                    ...
                                    className="h-full min-h-100 flex flex-col items-center justify-center text-center"
                                >
                                    ...
                                    <p className="text-white/60 max-w-sm">
                                        Thank you for your inquiry. Our team
                                        will contact you shortly via your
                                        preferred method.
                                    </p>
                                </motion.div>
                            ) : (
                                            ...
                                            <div className="p-6 rounded-2xl bg-amber-500/10 border border-amber-500/20 flex gap-4 items-start">
                                                ...
                                                <div>
                                                    <p className="text-sm text-amber-200/90 leading-relaxed">
                                                        <span className="text-amber-400 font-black uppercase tracking-wider text-xs block mb-1">
                                                            Important
                                                            Instruction
                                                        </span>
                                                        Carfax reports require a
                                                        small processing fee of{' '}
                                                        <span className="text-white font-bold">
                                                            $10
                                                        </span>
                                                        . Please send the fee
                                                        via Zelle or Venmo to{' '}
                                                        ...
                                                        >
                                                            ...
                                                            <div
                                                                className={cn(
                                                                    ...
                                                                    color.name ===
                                                                        'Other'
                                                                        ? 'bg-linear-to-tr from-white/20 via-white/40 to-white/20'
                                                                        : '',
                                                                )}
                                                                style={{
                                                                    backgroundColor:
                                                            ...
                                                            />
                                                            <span className="text-[9px] font-bold uppercase tracking-wider text-white/30 group-hover:text-white transition-colors">
                                                                {color.name}
                                                            </span>
                                                        </label>
                                                    ))}
                                    ...
                                    <div className="flex flex-col gap-6">
                                        <label className="flex gap-4 cursor-pointer group">
                                            ...
                                            <span className="text-[11px] text-white/40 leading-relaxed group-hover:text-white/60 transition-colors">
                                                ...
                                                emails, and SMS messages from{' '}
                                                <span className="text-white/60 font-bold">
                                                    JSMY AUTO SALES, INC
                                                </span>{' '}
                                                at the number provided,
                                                including for marketing
                                                purposes. Msg & data rates may
                                                apply. Consent is not a
                                                condition of purchase.
                                            </span>
                                        </label>

                                        {error && (
                                            <p className="text-red-400 text-xs font-bold pl-1">
                                                {error}
                                            </p>
                                        )}
